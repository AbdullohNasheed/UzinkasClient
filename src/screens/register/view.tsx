...
import {usePincodScreenHook} from './hooks';
          ...
          <View style={styles.passContainer}>
            ...
            <View style={styles.passCircleBox}>
              <View
                style={[
                  styles.circle,
                  passcode[0] ? styles.bgWhite : styles.circlee,
                ]}></View>
              <View
                style={[
                  styles.circle,
                  passcode[1] ? styles.bgWhite : styles.circlee,
                ]}></View>
              <View
                style={[
                  styles.circle,
                  passcode[2] ? styles.bgWhite : styles.circlee,
                ]}></View>
              <View
                style={[
                  styles.circle,
                  passcode[3] ? styles.bgWhite : styles.circlee,
                ]}></View>
              <View
                style={[
                  styles.circle,
                  passcode[4] ? styles.bgWhite : styles.circlee,
                ]}></View>
              <View
                style={[
                  styles.circle,
                  passcode[5] ? styles.bgWhite : styles.circlee,
                ]}></View>
            </View>
